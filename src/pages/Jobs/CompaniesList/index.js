                            ...
                            <Card className='card' id='company-overview'>
                                ...
                                <div className='card-body'>
                                    ...
                                    <p className='text-muted mb-4 overview-companydesc'>
                                        The IT department of NavLink company
                                        ensures that the network of computers
                                        within the organization are
                                        well-connected and functioning properly.
                                        All the other departments within the
                                        company rely on them to ensure that
                                        their respective functions can go on
                                        seamlessly.
                                    </p>
