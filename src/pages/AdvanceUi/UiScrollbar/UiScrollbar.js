                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>data-simplebar</code>{' '}
                                        attribute and add{' '}
                                        <code>max-height: **px</code> to set
                                        default scrollbar.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        attribute and add{' '}
                                        <code>max-height: **px</code> to show
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className='text-muted'>
                                                ...
                                                attribute to set primary color
                                                simplebar track.
                                            </p>
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className='text-muted'>
                                                ...
                                                attribute to set secondary color
                                                simplebar track.
                                            </p>
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className='text-muted'>
                                                ...
                                                attribute to set success color
                                                simplebar track.
                                            </p>
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className='text-muted'>
                                                ...
                                                attribute to set warning color
                                                simplebar track.
                                            </p>
