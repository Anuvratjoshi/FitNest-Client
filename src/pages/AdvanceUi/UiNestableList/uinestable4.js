                    ...
                    <Card>
                        ...
                        <CardBody>
                            <p className='text-muted'>
                                Use <code>nested-list nested-sortable</code>{' '}
                                class to list-group class to set a nested list
                                with sortable items where the list is shown with
                                navigation.
                            </p>
                                ...
                                <ReactDragListView {...dragProps}>
                                    {this.state.data.map((item, key) => (
                                        ...
                                        >
                                            ...
                                            <i
                                                className={
                                                    'fs-16 align-middle text-primary me-2 ' +
                                                    item.icon
                                                }
                                            ></i>{' '}
                                            {item.title}
