                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>default-swiper</code> class to
                                        set a default swiper.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>navigation-swiper</code> class
                                        to set a swiper with navigation and
                                        pagination.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>pagination-dynamic-swiper</code>{' '}
                                        class to set a dynamic swiper with
                                        pagination.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>pagination-fraction-swiper</code>{' '}
                                        class to set a fraction swiper with
                                        pagination.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>pagination-custom-swiper</code>{' '}
                                        class to set a swiper with custom
                                        pagination.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>pagination-progress-swiper</code>{' '}
                                        class to set a swiper with progress
                                        pagination.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>pagination-scrollbar-swiper</code>{' '}
                                        class to set a swiper with scrollbar
                                        pagination.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>vertical-swiper</code> class
                                        to set a vertical swiper.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>mousewheel-control-swiper</code>{' '}
                                        class to set a swiper with mousewheel
                                        scroll.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>effect-fade-swiper</code>{' '}
                                        class to set a swiper with fade effect.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>effect-creative-swiper</code>{' '}
                                        class to set a swiper with creative
                                        custom effect.
                                    </p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>effect-flip-swiper</code>{' '}
                                        class to set a swiper with flip effect.
                                    </p>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>effect-coverflow-swiper</code>{' '}
                                        class to set a swiper with coverflow
                                        effect.
                                    </p>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>responsive-swiper</code> class
                                        to set a responsive swiper.
                                    </p>
