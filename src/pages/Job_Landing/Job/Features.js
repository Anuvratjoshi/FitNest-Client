                        ...
                        <Col lg={6}>
                            <div className='text-muted'>
                                ...
                                <p className='ff-secondary fs-16 mb-2'>
                                    The first step in finding your{' '}
                                    <b>dream job </b> is deciding where to look
                                    for first-hand insight. Contact
                                    professionals who are already working in
                                    industries or positions that interest you.
                                </p>
                                <p className='ff-secondary fs-16'>
                                    Schedule informational interviews and phone
                                    calls or ask for the opportunity to shadow
                                    them on the job.
                                </p>
