                        ...
                        <Col className='col-lg-6 order-2 order-lg-1'>
                            <div className='text-muted mt-5 mt-lg-0'>
                                ...
                                <p className='ff-secondary mb-2'>
                                    The demand for content writing services is
                                    growing. This is because content is required
                                    in almost every industry.{' '}
                                    <b>
                                        Many companies have discovered how
                                        effective content marketing is.
                                    </b>{' '}
                                    This is Link major reason for this increase
                                    in demand.
                                </p>
                                <p className='mb-4 ff-secondary'>
                                    A Content Writer is Link professional who
                                    writes informative and engaging articles to
                                    help brands showcase their products.
                                </p>
                            ...
                            <div>
                                <Card className='shadow-lg'>
                                    <CardBody>
                                        ...
                                        <p className='text-muted'>
                                            As NavLink Product Designer, you
                                            will work within NavLink Product
                                            Delivery Team fused with UX,
