                                    ...
                                    contact.row.original.image_src ? (
                                        ...
                                        <div className='flex-shrink-0 avatar-xs me-2'>
                                            <div className='avatar-title bg-success-subtle text-success rounded-circle fs-13'>
                                                {contact.row.original.name.charAt(
                                                    0,
                                                )}
                                            </div>
                                        </div>
                ...
                Cell: contact => (
                    <>
                        ...
                        <small className='text-muted'>
                            {handleValidTime(
                                contact.row.original.last_contacted,
                            )}
                        </small>
                    </>
                ),
                            ...
                            <Card id='contact-view-detail'>
                                ...
                                <CardBody>
                                    ...
                                    <p className='text-muted mb-4'>
                                        Hello, I'm {info.name || 'Tonya Noble'},
                                        The most effective objective is one that
                                        is tailored to the job you are applying
                                        for. It states what kind of career you
                                        are seeking, and what skills and
                                        experiences.
                                    </p>
