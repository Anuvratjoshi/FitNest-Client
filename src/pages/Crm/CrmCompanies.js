                                ...
                                {company.row.original.image_src ? (
                                    ...
                                    <div className='flex-shrink-0 avatar-xs me-2'>
                                        <div className='avatar-title bg-success-subtle text-success rounded-circle fs-13'>
                                            {company.row.original.name.charAt(
                                                0,
                                            )}
                                        </div>
                                    </div>
                            ...
                            <Card id='company-view-detail'>
                                ...
                                <div className='card-body'>
                                    ...
                                    <p className='text-muted mb-4'>
                                        A company incurs fixed and variable
                                        costs such as the purchase of raw
                                        materials, salaries and overhead, as
                                        explained by AccountingTools, Inc.
                                        Business owners have the discretion to
