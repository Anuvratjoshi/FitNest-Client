        ...
        <div className='col'>
            <Card>
                <Link
                    to='#'
                    className={
                        'card-header bg-' + props.deal.bgColor + '-subtle'
                    }
                    ...
                    <React.Fragment key={subitemkey}>
                        ...
                        >
                            ...
                            <UncontrolledCollapse
                                ...
                                defaultOpen={
                                    subitem.isOpen === true ? true : false
                                }
                            >
                                <CardBody>
                                    <h6 className='fs-14 mb-1'>
                                    ...
                                    <p className='text-muted'>
                                        As a company grows however, you find
                                        it's not as easy to shout across
                                    </p>
