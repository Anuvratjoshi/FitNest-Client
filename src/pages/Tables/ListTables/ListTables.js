                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use data attributes and other custom
                                        attributes as keys
                                    </p>
                                    <div id='users'>
                                        <Row className='mb-2'>
                        ...
                        <Col xl={4}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Example of how to use the fuzzy search
                                        plugin
                                    </p>
                    ...
                    <Row>
                        <Col xl={4}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Example of how to use the pagination
                                        plugin
                                    </p>
