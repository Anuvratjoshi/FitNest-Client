                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table</code> class to show
                                        bootstrap-based default table.
                                    </p>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-striped</code> class to
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-dark</code> class to set
                                        dark color table body and{' '}
                                        <code>table-success</code> class to set
                                        success color table body respectively.
                                        use <code>table-</code> class with
                                        different color variation to set
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-hover</code> class to
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-4'>
                                        Use <code>table-card</code> class to
                                        show card-based table within a
                                        &lt;tbody&gt;.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='table-responsive table-card'>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-active</code> class to
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-bordered</code> class to
                                        show borders on all sides of the table
                                        and cells.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='table-responsive'>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>border-</code> class with
                                        color variation class to set table
                                        border color.
                                    </p>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-borderless</code> to set
                    ...
                    <Row>
                        <Col xl='6'>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-sm</code> class to
                                        create any table more compact by cutting
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>table-dark</code> class to create
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Add <code>&lt;tbody&gt;</code> attribute
                                        to group footer content in an HTML
                                        table.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='table-responsive'>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Example of basic table nesting. Border
                                        styles, active styles, and table
                                        variants are not inherited by nested
                                        tables.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='table-responsive'>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        Use <code>table-</code> class with
                                        below-mentioned color variation class
                                        within &lt;tr&gt; to set color on table
                                        row.
                                    </p>
                        ...
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Table cells of{' '}
                                        <code>&lt;thead&gt;</code> are always
                                        vertical aligned to the bottom. Table
                                        cells in <code>&lt;tbody&gt;</code>{' '}
                                        inherit their alignment from{' '}
                                        <code>&lt;table&gt;</code> and are
                                        aligned to the the top by default. Use
                                        the vertical align classes to re-align
                                        where needed.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='table-responsive'>
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>table-responsive</code> class
                                        to make any table responsive across all
                                        viewports. Responsive tables allow
                                        tables to be scrolled horizontally with
                                        ease.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='table-responsive'>
