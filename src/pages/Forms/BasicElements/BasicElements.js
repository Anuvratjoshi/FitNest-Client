...
const BasicElements = () => {
    document.title =
        'Basic Elements | Velzon - React Admin & Dashboard Template'
                                        ...
                                        <Row className='gy-4'>
                                            ...
                                            <Col xxl={3} md={6}>
                                                ...
                                                <datalist id='datalistOptions'>
                                                    ...
                                                    <option defaultValue='France'>
                                                        {' '}
                                                    </option>
                                                    <option defaultValue='Spain'>
                                                        {' '}
                                                    </option>
                                                    <option defaultValue='Chicago'>
                                                        {' '}
                                                    </option>
                                                    <option defaultValue='Bulgaria'>
                                                        {' '}
                                                    </option>
                            ...
                            <Card>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        ...
                                        to set large size input and Use{' '}
                                        <code>form-control-sm</code> class to
                                        set small size input. No class is needed
                                        for default size input.
                                    </p>
                                    <div className='live-preview'>
                                ...
                                <CardBody>
                                    <div className='live-preview'>
                                        <div>
                                            ...
                                            <p className='text-muted'>
                                                Use <code>input-group</code>{' '}
                                                class to div element which
                                                contains input attribute to wrap
                                                a default input in the group.
                                            </p>
                                            <Row className='g-3'>
                                                <Col lg={6}>
                                        ...
                                        <div className='mt-4'>
                                            ...
                                            <p className='text-muted'>
                                                ...
                                                <code>flex-wrap: wrap</code> in
                                                order to accommodate custom form
                                                field validation within an input
                                                group. You may disable this with{' '}
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        Use <code>input-group-sm</code> class to
                                        set a small size input group and{' '}
                                        <code>input-group-lg</code> class to
                                        input-group class to set a large size
                                        input group respectively. no such class
                                        is required for a default size input
                                        group.
                                    </p>
                                    <div className='live-preview'>
                                        <Row className='align-items-center g-3'>
                        ...
                        <Col lg={12}>
                            <div className='card'>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        While multiple{' '}
                                        <code>&lt;input&gt;</code>s are
                                        supported visually, validation styles
                                        are only available for input groups with
                                        a single <code>&lt;input&gt;</code>.
                                    </p>
                                    <div className='live-preview'>
                            ...
                            <div className='card'>
                                ...
                                <div className='card-body'>
                                    <div className='live-preview'>
                                        <div>
                                            <p className='text-muted'>
                                                Use any checkbox, radio, or
                                                button option within an input
                            ...
                            <Card>
                                ...
                                <div className='card-body'>
                                    <div className='live-preview'>
                                        <div>
                                            <p className='text-muted'>
                                                You can use a button with the
                                                dropdown toggle to set the file
                                                input group.
                                            </p>
                                            <Row className='g-3'>
                                                <Col lg={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        Input groups include support for custom
                                        selects and custom file inputs. Browser
                                        default versions of these are not
                                        supported.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
