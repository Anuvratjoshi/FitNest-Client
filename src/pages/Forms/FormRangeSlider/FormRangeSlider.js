                                    ...
                                    <div className='live-preview'>
                                        <div>
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                <p className='text-muted'>
                                                    Use <code>disabled</code>{' '}
                                                    attribute on an input to
                                                    give it a grayed out
                                                    appearance and remove
                                                    pointer events.
                                                </p>
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                <p className='text-muted'>
                                                    Use <code>min</code> and{' '}
                                                    <code>max</code> attribute
                                                    with specified range input
                                                    respectively.
                                                </p>
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                <p className='text-muted'>
                                                    ...
                                                    "snap" to integer values. To
                                                    change this, you can specify
                                                    a step value. In the example
                                                    below, we double the number
                                                    of steps by using{' '}
                                                    <code>step="0.5"</code>{' '}
                                                    attribute.
                                                </p>
                                        ...
                                        <Col xl={4} lg={6}>
                                            <div className='mt-4'>
                                                ...
                                                <p className='text-muted mb-4'>
                                                    ...
                                                    <code>
                                                        data-rangeslider
                                                        data-slider-color=&quot;dark&quot;
                                                    </code>{' '}
                                                    attribute to set dark color
                                                    scheme.
                                                </p>
                                                <div
                                                    data-rangeslider
