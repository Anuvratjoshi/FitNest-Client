                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        More complex forms can be built using
                                        our grid classes. Use these for form
                                        layouts that require multiple columns,
                                        varied widths, and additional alignment
                                        options.{' '}
                            ...
                            <Card>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        ...
                                        , you can have control over the gutter
                                        width in as well the inline as block
                                        direction.{' '}
                                        <span className='fw-medium'>
                                            Also requires the{' '}
                                            <code>$enable-grid-classes</code>{' '}
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Example of vertical form using{' '}
                                        <code>form-control</code> class. No need
                                        to specify row and col class to create
                                        vertical form.
                                    </p>
                                    <div className='live-preview'>
                                        <Form action='#'>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Create horizontal forms with the grid by
                                        adding the <code>row</code> class to
                                        form groups and using the{' '}
                                        <code>col-*-*</code>
                                        class to specify the width of your
                                        labels and controls. Be sure to add{' '}
                                        <code>col-form-label</code>
                                        class to your <code>&lt;label&gt;</code>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>col-form-label-sm</code> class
                                        to set small size form label or{' '}
                                        <code>col-form-label-lg</code> class to
                                        set large size form label to
                                        &lt;label&gt;. No such class is required
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        Use <code>col-sm-</code> class with
                                        required size value to set column size
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Change <code>col</code> class to{' '}
                                        <code>col-auto</code> class so that your
                                        columns only take up as much space as
                                        needed. Put another way, the column
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>row-cols-*</code> class to set
                                        form inline.
                                    </p>
                                    <div className='live-preview'>
                                        <Form action='#'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>form-floating</code> class to
                                        enable floating labels with Bootstrap’s
                                        textual form fields.
                                    </p>
                                    <div className='live-preview'>
                                        <Form action='#'>
                                            <Row className='g-3'>
                                                ...
                                                <Col lg={4}>
                                                    <div className='form-floating'>
                                                        <Input
                                                            ...
                                                            placeholder='Enter your city'
                                                        />
                                                        <Label htmlFor='cityfloatingInput'>
                                                            City
                                                        </Label>
                                                    </div>
                                                </Col>
                                                ...
                                                <Col lg={4}>
                                                    <div className='form-floating'>
                                                        ...
                                                        />
                                                        <Label htmlFor='zipfloatingInput'>
                                                            Zipcode
                                                        </Label>
                                                    </div>
                                                </Col>
