                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        attribute with numerous options to show
                                        value with choice's option.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>form-select-sm</code> class to
                                        set small select size and{' '}
                                        <code>form-select-lg</code> class to
                                        form-select class to set large select
                                        size. No such class is required for
                                        default select size.
                                    </p>
                                    <div className='live-preview'>
