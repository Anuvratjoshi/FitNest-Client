                                            ...
                                            <Col md={6}>
                                                <div>
                                                    <p className='text-muted'>
                                                        ...
                                                        class with
                                                        below-mentioned color
                                                        variation to set a color
                                                        checkbox.
                                                    </p>
                                                    <div>
                                            ...
                                            <Col lg={4} md={6}>
                                                <div className='mt-3'>
                                                    ...
                                                    <p className='text-muted'>
                                                        ...
                                                        class to set a medium
                                                        size switch button and
                                                        <code>
                                                            form-switch-lg
                                                        </code>{' '}
                                                        class to form-check
                                                        class to set a large
                                                        size switch button
                                                        respectively. No such
                            ...
                            <Card>
                                ...
                                <div className='card-body'>
                                    <p className='text-muted'>
                                        ...
                                        below-mentioned color variation to set a
                                        color switch.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                    ...
                    <Row>
                        <div className='col-12'>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>form-switch-custom</code>{' '}
                                        class &amp; <code>form-switch-</code>{' '}
                    ...
                    <Row>
                        <Col xs={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>form-check-inline</code> class
                                        to form-check class to set horizontally
                                        align checkboxes, radios, or switches.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                                            <Col lg={4}>
                        ...
                        <Col xs={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Omit the wrapping,{' '}
                                        <code>form-check</code> class for
                                        checkboxes, radios, or switches that
                                        have no label text. Remember to still
                                        provide some form of accessible name for
                                        assistive technologies (for instance,
                                        using aria-label).
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Create button-like checkboxes and radio
                                        buttons by using <code>btn</code> styles
                                        rather than form-check-label class on
                                        the &lt;label&gt; elements. These toggle
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Different variants of <code>btn</code>{' '}
                                        attribute, such as the various outlined
