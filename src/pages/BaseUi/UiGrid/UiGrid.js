                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>align-items-start</code> class
                                        to vertically align-items at the start.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>align-items-center</code>{' '}
                                        class to vertically align-items at the
                                        center.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>align-items-end</code> class
                                        to vertically align-items at the end.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='bg-light p-3 text-center'>
                                            <Row
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>align-self-end</code> class
                                        respectively to vertically align items
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>justify-content-end</code> class
                                        respectively to horizontally align items
                                        with a different position.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='bg-light p-3 text-center'>
