                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>Button</code> tag to show
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>outline</code> atrribute with
                                        the below-mentioned variation to create
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-soft-</code> class with
                                        the below-mentioned variation to create
                                        a button with the soft background.
                                    </p>{' '}
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-2'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-ghost-</code> class with
                                        the below-mentioned variation to create
                                        a button with the transparent
                                        background.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-2'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>bg-gradient </code>class to
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>bg-animation </code>class to
                                    ...
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-2'>
                                            <Button
                                                color='primary'
                                                className='btn-animation waves-effect waves-light btn btn-primary'
                                                data-text='Primary'
                                            >
                                                {' '}
                                                <span>Primary</span>{' '}
                                            ...
                                            <Button
                                                color='secondary'
                                                className='btn-animation waves-effect waves-light btn btn-Secondary'
                                                data-text='Secondary'
                                            >
                                                {' '}
                                                <span>Secondary</span>{' '}
                                            ...
                                            <Button
                                                color='success'
                                                className='btn-animation waves-effect waves-light btn btn-Success'
                                                data-text='Success'
                                            >
                                                {' '}
                                                <span>Success</span>{' '}
                                            ...
                                            <Button
                                                color='info'
                                                className='btn-animation waves-effect waves-light btn btn-Info'
                                                data-text='Info'
                                            >
                                                {' '}
                                                <span>Info</span>{' '}
                                            ...
                                            <Button
                                                color='warning'
                                                className='btn-animation waves-effect waves-light btn btn-Warning'
                                                data-text='Warning'
                                            >
                                                {' '}
                                                <span>Warning</span>{' '}
                                            ...
                                            <Button
                                                color='danger'
                                                className='btn-animation waves-effect waves-light btn btn-Danger'
                                                data-text='Danger'
                                            >
                                                {' '}
                                                <span>Danger</span>{' '}
                                            ...
                                            <Button
                                                color='dark'
                                                className='btn-animation waves-effect waves-light btn btn-Dark'
                                                data-text='Dark'
                                            >
                                                {' '}
                                                <span>Dark</span>{' '}
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-label </code>class to
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Example of simple bottom borderd
                                        buttons.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-lg</code> class to create
                                        a large size button and{' '}
                                        <code>btn-sm</code> class to create a
                                        small size button.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap align-items-center gap-2'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>w-xs,w-sm,w-md,w-lg</code>{' '}
                                        class to make different sized buttons
                                        respectively.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-2'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn</code> class with
                                        different HTML elements. (though some
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Bootstrap has a base <code>.btn</code>{' '}
                                        class that sets up basic styles such as
                                        padding and content alignment. By
                                        default, <code>.btn</code> controls have
                                        a transparent border and background
                                        color, and lack any explicit focus and
                                        hover styles.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-2'>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        You can even roll your own custom sizing
                                        with CSS variables:
                                    </p>
                                    <div className='live-preview'>
                                        <Button
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>data-bs-toggle="button"</code>{' '}
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>d-grid</code> class to create
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>btn-group </code> class in
                                        the parent class to wrap a series of
                                        buttons.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-icon</code> class to wrap
                                        icon in button
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-toolbar</code> class to
                                        combine sets of button groups into more
                                        complex components.
                                    </p>
                                    <div className='live-preview'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-group-</code> class with
                                        the below-mentioned variation to set the
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>vertically</code> stacked .Split
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Click directly on the link below to see
                                        the focus ring in action, or into the
                                        example below and then press{' '}
                                        <kbd>Tab</kbd>.
                                    </p>
                                    <div className='live-preview'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p class='text-muted'>
                                        In addition to <code>.focus-ring</code>,
                                        we have several{' '}
                                        <code>.focus-ring-*</code> utilities to
                                        modify the helper class defaults. Modify
                                        the color with any of our{' '}
                                        <a href='ui-colors.html'>
                                            theme colors
                                        </a>
                                        . Note that the light and dark variants
                                        may not be visible on all background
