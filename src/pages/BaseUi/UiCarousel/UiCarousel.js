                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use<code> slide</code> class to set
                                        carousel with slides. Note the presence
                                        of the <code>d-block</code>
                                        and <code>w-100</code> class on carousel
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>carousel-control-prev</code>{' '}
                                        and <code>carousel-control-next</code>
                                        class with &lt;button&gt; or &lt;a&gt;
                                        tag element to show carousel with
                                        control navigation.
                                    </p>
                                    <div className='live-preview'>
                                        <Slidewithcontrol />
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>carousel-indicators</code>{' '}
                                        class with &lt;ol&gt; element to show
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>carousel-caption</code> class
                                        to add captions to the carousel.
                                    </p>
                                    <div className='live-preview'>
                                        <Slidewithcaption />
                                    </div>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>carousel-fade</code> class to
                                        the carousel to animate slides with a
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>data-bs-interval=" "</code> to
                                        a carousel-item to change the amount of
                                        time to delay between automatically
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        the
                                        <code>data-bs-ride attribute</code> and
                                        has{' '}
                                        <code>data-bs-interval="false"</code> so
                                        it doesn’t autoplay.
                                    </p>
                                    <div className='live-preview'>
                                        <DisableTouch />
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>carousel-dark</code> class to
                                        the carousel for darker controls,
