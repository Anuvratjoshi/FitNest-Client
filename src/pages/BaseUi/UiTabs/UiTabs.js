                    ...
                    <Row>
                                    ...
                                    >
                                        <TabPane tabId='1' id='home'>
                                            ...
                                            <p className='mb-0'>
                                                ...
                                                They can come across as casual
                                                or neutral, exotic or graphic.
                                                That's why it's important to
                                                think about your message, then
                                                choose a font that fits. Cosby
                                                sweater eu banh mi, qui irure
                                        ...
                                        <TabPane tabId='2' id='product'>
                                            ...
                                            <p className='mb-0'>
                                                ...
                                                opposites attract. The same is
                                                true for fonts. Don't be afraid
                                                to combine font styles that are
                                                different but complementary,
                                                like sans serif with serif,
                                                short with tall, or decorative
                                                with simple. Qui photo booth
                                                letterpress, commodo enim craft
                                        ...
                                        <TabPane tabId='3' id='messages'>
                                            <h6>Messages</h6>
                                            <p className='mb-0'>
                                                Etsy mixtape wayfarers, ethical
                                                wes anderson tofu before they
                                                sold out mcsweeney's organic
                                                lomo retro fanny pack lo-fi
                                        ...
                                        <TabPane tabId='4' id='settings'>
                                            ...
                                            <p className='mb-0'>
                                                ...
                                                keytar raw denim keffiyeh etsy
                                                art party before they sold out
                                                master cleanse gluten-free squid
                                                scenester freegan cosby sweater.
                                                Fanny pack portland seitan DIY,
                                                art party locavore wolf cliche
                                                high life echo park Austin. Cred
                                                vinyl keffiyeh DIY salvia PBR,
                                                banh mi before they sold out
                                                farm-to-table VHS.
                                            </p>
                                        </TabPane>
                                    </TabContent>
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>nav-justified</code> class to
                                        generate equal-width elements with all
                                        horizontal space will be occupied by nav
                                        links.
                                    </p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>nav-pills</code> class to
                                        generate particular selected nav links
                                        without borders.
                                    </p>
                                    ...
                                    >
                                        <TabPane tabId='1' id='home-1'>
                                            ...
                                            <div className='d-flex mt-2'>
                                                ...
                                                <div className='flex-grow-1 ms-2'>
                                                    ...
                                                    spacing, as in the example
                                                    below, can make things
                                                    unpleasant for the reader.
                                                    The goal is to make your
                                                    text as comfortable to read
                                                    as possible.
                                                </div>
                                            </div>
                                        </TabPane>
                                        ...
                                        <TabPane tabId='3' id='messages-1'>
                                            ...
                                            <div className='d-flex mt-2'>
                                                ...
                                                <div className='flex-grow-1 ms-2'>
                                                    For that very reason, I went
                                                    on a quest and spoke to many
                                                    different professional
                                                    graphic designers and asked
                                                    them what graphic design
                                                    tips they live.
                                                </div>
                                            </div>
                                        </TabPane>
                                        ...
                                        <TabPane tabId='4' id='settings-1'>
                                            ...
                                            <div className='d-flex mt-2'>
                                                ...
                                                <div className='flex-grow-1 ms-2'>
                                                    After gathering lots of
                                                    different opinions and
                                                    graphic design basics, I
                                                    came up with a list of 30
                                                    graphic design tips that you
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>nav-pills nav-justified</code>{' '}
                                        class to generate equal-width elements
                                        without borders, all horizontal space
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>flex-column</code> class to
                                        create Vertical nav tabs.
                                    </p>
                                    <Row>
                                        <Col md={3}>
                                            <Nav
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <p className='mb-0'>
                                                        ...
                                                        commonly encountered tip
                                                        I received from the
                                                        designers I spoke with.
                                                        They highly encourage
                                                        that you use different
                                                        fonts in one design, but
                                                ...
                                                >
                                                    ...
                                                    <p className='mb-0'>
                                                        ...
                                                        fonts in one design, but
                                                        do not over-exaggerate
                                                        and go overboard This
                                                        may be the most commonly
                                                        encountered tip I
                                                        received from the
                                                        designers I spoke with.
                                                    </p>
                                ...
                                <div className='card-header align-items-center d-flex'>
                                    <div className='flex-grow-1 oveflow-hidden'>
                                        <p className='text-muted text-truncates mb-0'>
                                            Use <code>card-header-tabs</code>{' '}
                                            class to create card header tabs.
                                        </p>
                                    </div>
                                    ...
                                    >
                                        <TabPane tabId='1' id='home2'>
                                            <p className='flex-grow-1 mb-0'>
                                                ...
                                                squid. Exercitation +1 labore
                                                velit, blog sartorial PBR
                                                leggings next level wes anderson
                                                artisan four loko farm-to-table
                                                craft beer twee. commodo enim
                                                craft beer mlkshk aliquip jean
                                                shorts ullamco ad vinyl cillum
                                                PBR. Homo nostrud organic,
                                                assumenda labore aesthetic magna
                                                delectus.commodo enim craft beer
                                                mlkshk aliquip jean shorts
                                                ullamco ad vinyl cillum PBR.
                                                Homo nostrud organic, assumenda
                                                labore aesthetic magna delectus.
                                                If you’re using multiple
                                                elements, make sure that your
                                                principal object is larger than
                                                assumenda.
                                            </p>
                                        </TabPane>
                                        ...
                                        <TabPane tabId='2' id='profile2'>
                                            <p className='me-3 mb-0'>
                                                ...
                                                aliquip jean shorts ullamco ad
                                                vinyl cillum PBR. Homo nostrud
                                                organic, assumenda labore
                                                aesthetic magna delectus.commodo
                                                enim craft beer mlkshk aliquip
                                                jean shorts ullamco ad vinyl
                                                cillum PBR. Homo nostrud
                                                organic, assumenda labore
                                                aesthetic magna delectus Scale
                                                all elements of your design:
                                                text, elements, buttons,
                                                everything. Increase or decrease
                                                the letter spacing depending on
                                                the situation and try, try again
                                        ...
                                        <TabPane tabId='3' id='messages2'>
                                            <p className='ms-3 mb-0'>
                                                ...
                                                assumenda labore aesthetic magna
                                                delectus Scale all elements of
                                                your design: text, elements,
                                                buttons, everything.Increase or
                                                decrease the letter spacing
                                                depending on the situation and
                                                try, try again until it looks
                                                right, and each.
                                            </p>
                                        </TabPane>
                                    </TabContent>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>nav-tabs-custom</code> class
                                        to create custom tabs with borders.
                                    </p>
                                    <Nav
                                        tabs
                                    ...
                                    >
                                        ...
                                        <TabPane tabId='2'>
                                            <div className='d-flex'>
                                                ...
                                                <div className='flex-grow-1 ms-2'>
                                                    ...
                                                    valley teems with vapour
                                                    around me, and the meridian
                                                    sun strikes the upper
                                                    surface of the impenetrable
                                                    foliage of my trees, and but
                                                    a few stray gleams steal
                                                    into the inner sanctuary, I
                                                    throw myself down among the
                                                    tall grass by the trickling
                                                    stream; and, as I lie close
                                                    to the earth, a thousand
                                                    unknown.
                                                    <div className='mt-2'>
                                                        <Link
                                                            to='#'
                                        ...
                                        <TabPane tabId='4'>
                                            <div className='d-flex'>
                                                ...
                                                <div className='flex-grow-1 ms-2'>
                                                    when darkness overspreads my
                                                    eyes, and heaven and earth
                                                    seem to dwell in my soul and
                                                    absorb its power, like the
                                                    form of a beloved mistress,
                                                    then I often think with
                                                    longing, Oh, would I could
                                                    describe these conceptions,
                                                    could impress upon paper all
                                                    that is living so full and
                                                    warm within me, that it
                                                    might be the.
                                                    <div className='mt-2'>
                                                        <Link
                                                            to='#'
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>arrow-navtabs </code>class to
                                        create arrow nav tabs.
                                    </p>
                                    <Nav
                                        pills
                                    ...
                                    >
                                        <TabPane tabId='1' id='arrow-overview'>
                                            ...
                                            <p className='mb-0'>
                                                ...
                                                by using complicated 3D
                                                elements. Flat design is your
                                                friend. Remember that. And the
                                                great thing about flat design is
                                                that it has become more and more
                                                popular over the years, which is
                                                excellent news to the beginner
                                        ...
                                        <TabPane tabId='2' id='arrow-profile'>
                                            ...
                                            <p className='mb-0'>
                                                Opposites attract, and that’s a
                                                fact. It’s in our nature to be
                                                interested in the unusual, and
                                                that’s why using contrasting
                                                colors in{' '}
                                                <Link
                                                    to='#'
                                                    className='text-decoration-underline'
                                                ...
                                                is a must. It’s eye-catching, it
                                        ...
                                        <TabPane tabId='3' id='arrow-contact'>
                                            ...
                                            <p className='mb-0'>
                                                ...
                                                an awareness campaign, it is
                                                vital for people to begin put 2
                                                and 2 together and begin to
                                                recognize your cause.
                                                Consistency piques people’s
                                                interest is that it has become
                                                more and more popular over the
                                                years, which is excellent news
                                                to the beginner and advanced{' '}
                                                <Link
                                                    to='#'
                                                    className='text-decoration-underline'
                                                >
                    ...
                    <Row>
                            ...
                            <Card>
                                <div className='card-header align-items-xl-center d-xl-flex'>
                                    <p className='text-muted flex-grow-1 mb-xl-0'>
                                        Use <code>card-header-pills</code> class
                                        to create header justify tab.
                                    </p>
                                    <div className='flex-shrink-0'>
                                        <Nav
                                            pills
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>card-footer-tabs</code> class
                                        to create the bottom card nav justify
                                        tab.
                                    </p>
                                    <TabContent
                                        activeTab={bottomCardTab}
                                        className='text-muted'
                                    >
                                        <TabPane tabId='1' id='bottomtabs-home'>
                                            ...
                                            <p className='mb-2'>
                                                ...
                                                color consistency is a MUST. If
                                                you’re not trying to create
                                                crazy contrast in your design,
                                                then a great idea would be for
                                                you to use a color palette
                                                throughout your entire design.
                                                It will subconsciously interest
                                                viewers and also is very
                                                pleasing to look at.
                                            </p>
                                            <p className='mb-0'>
                                                Any bypasser will stop to see
                                                what you have to see, even if
                                                your design has nothing to do
                                                with them, for the simple fact
                                        ...
                                        >
                                            ...
                                            <p className='mb-2'>
                                                Just like in the image where we
                                                talked about using multiple
                                                fonts, you can see that the
                                                background in this graphic
                                                design is blurred. Whenever you
                                                put text on top of an image,
                                                it’s important that your viewers
                                                can understand the text, and
                                                sometimes that means applying a
                                                gaussian readable.
                                            </p>
                                            <p className='mb-0'>
                                                A very bad quack might jinx
                                                zippy fowls. Few quips
                                                galvanized the mock jury box.
                                                Quick brown dogs jump over the
                                                lazy fox. The jay, pig, fox,
                                                zebra, and my wolves.
                                            </p>
                                        </TabPane>
                                        ...
                                        >
                                            ...
                                            <p className='mb-2'>
                                                Blowzy red vixens fight for a
                                                quick jump. Joaquin Phoenix was
                                                gazed by MTV for luck. A
                                                wizard’s job is to vex chumps
                                                quickly in fog. Watch "Jeopardy!
                                                ", Alex Trebek's fun TV quiz
                                                game. Woven silk pyjamas
                                                exchanged for blue quartz.
                                                Brawny gods just flocked up to
                                                quiz and vex him.
                                            </p>
                                            <p className='mb-0'>
                                                Big July earthquakes confound
                                                zany experimental vow. My girl
                                                wove six dozen plaid jackets
                                                before she quit. Six big devils
                                                from Japan quickly forgot how to
                                                waltz.
                                            </p>
                                        </TabPane>
                                    </TabContent>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>custom-hover-nav-tabs</code>{' '}
                                        class to create custom hover tabs.
                                    </p>
                                </CardBody>
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>custom-verti-nav-pills</code>{' '}
                                        class to create custom vertical tabs.
                                    </p>
                                    <Row>
                                        <Col lg={3}>
                                            <Nav
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>animation-nav</code> class to
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Example of nav tabs with badge wrapped
                                        in nav item.
                                    </p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>nav-border-top</code> class to
                                        create nav tabs with border at top.
                                    </p>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>
                                            nav-border-top nav-justified
                                        </code>{' '}
                                        class to create nav tabs with border at
                                        top with justified tabs position.
                                    </p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        *Use <code>nav-custom-</code> class with
                                        modifier class to color tabs.
                                    </p>
                                            ...
                                            >
                                                ...
                                                <div className='d-flex mt-2'>
                                                    ...
                                                    <div className='flex-grow-1 ms-2'>
                                                        ...
                                                        the reader. The goal is
                                                        to make your text as
                                                        comfortable to read as
                                                        possible.
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <Row>
                                        ...
                                        >
                                            ...
                                            <div className='d-flex'>
                                                <div className='flex-grow-1 me-3'>
                                                    ...
                                                    the situation and try, try
                                                    again until it looks right,
                                                    and each assumenda labore
                                                    aes Homo nostrud organic,
                                                    assumenda labore aesthetic
                                                    magna elements, buttons,
                                                    everything..
                                                </div>
                                                <div className='flex-shrink-0'>
                                                    <img
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>nav-custom-light</code> class
                                        to lighten the nav tabs area.
                                    </p>
                                    ...
                                    >
                                        ...
                                        >
                                            <div className='d-flex mb-1'>
                                                <div className='flex-grow-1 me-3'>
                                                    Just like in the image where
                                                    we talked about using
                                                    multiple fonts, you can see
                                                    that the background in this
                                                    graphic design is blurred.
                                                    Whenever you put text on top
                                                    of an image, it’s important
                                                    that your viewers can
                                                    understand the text, and
                                                    sometimes that means
                                                    applying a gaussian readable
                                                    Any bypasser will stop to
                                                    see what you have to see,
                                                    even if your design has
                                        ...
                                        >
                                            <div className='d-flex mb-1'>
                                                <div className='flex-grow-1 me-3'>
                                                    ...
                                                    high life echo park Austin
                                                    On the note of consistency,
                                                    color consistency is a MUST.
                                                    If you’re not trying to
                                                    create crazy contrast in
                                                    your design.
                                                </div>
                                                <div className='flex-shrink-0'>
                                                    <img
                                            ...
                                            <p className='mb-0'>
                                                ...
                                                before she quit. Six big devils
                                                from Japan quickly forgot how to
                                                waltz. try again until it looks
                                                right, and each assumenda labore
                                                aes Homo nostrud organic,
                                                assumenda labore aesthetic magna
