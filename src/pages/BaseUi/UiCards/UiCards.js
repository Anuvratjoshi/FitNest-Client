                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className='card-text'>
                                        At missed advice my it no sister. Miss
                                        told ham dull knew see she spot near
                                        can. Spirit her entire her called.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className='card-text mb-0'>
                                        ...
                                        hastily sitting her. Money witty books
                                        nor son add. Chicken age had evening
                                ...
                                <div className='card-footer'>
                                    ...
                                    <Link
                                        to='#'
                                        className='card-link link-success'
                                    >
                                        Bookmark{' '}
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='card-text'>
                                        ...
                                        including the most common of all making
                                        mistakes.
                                    </p>
                                </CardBody>
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='card-text'>
                                        Objectively pursue diverse catalysts for
                                        change for interoperable meta-services.
                            ...
                            <Row>
                                <Col lg={6} xxl={4}>
                                    <Card className='card-body'>
                                        ...
                                        <p className='card-text text-muted'>
                                            Send a link to apply on mobile
                                            device. Appropriately communicate
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            ...
                                            <p className='card-text text-muted mb-0'>
                                                ...
                                                businesses. Miss told ham dull
                                                knew see she spot near can.
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            ...
                                            <p className='card-text text-muted mb-0'>
                                                ...
                                                opportunities and real-time
                                                potentialities for change for
                        ...
                        <Col xl={4}>
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='text-muted mb-0'>
                                        This response is important for our
                                        ability to learn from mistakes, but it
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        have to work endless nights and hours to
                                        create a{' '}
                                        <Link
                                            to='#'
                                        ...
                                        by using complicated 3D elements. Flat
                                        design is your friend. Remember that.
                                        And the great thing about flat design is
                                        that it has become more and more popular
                                        over the years.
                                    </p>
                                    <p className='text-muted mb-0'>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        art birthed into this world.
                                    </p>
                                    <p className='text-muted mb-0'>
                                        Art party locavore wolf cliche high life
                                        echo park Austin.
                                    </p>
                                </CardBody>
                                <div className='card-footer'>
                                    <div className='hstack gap-2 justify-content-end'>
                                        <Link
                                            to='#'
                                            className='btn btn-link btn-sm link-success'
                                        >
                                            <i className='ri-close-line align-middle lh-1'></i>{' '}
                                            Close
                                        </Link>
                                        <Link
                                            to='#'
                        ...
                        <Col xl={4} id='card-none1'>
                            <Card>
                                <CardHeader>
                                    ...
                                    <div
                                        className='card-preloader d-none'
                                        id='spinner1'
                                    >
                                ...
                                >
                                    ...
                                    <div className='d-flex mt-2'>
                                        ...
                                        <div className='flex-grow-1 ms-2 text-muted'>
                                            Too much or too little spacing, as
                                            in the example below, can make
                                            things unpleasant for the reader.
                                            The goal is to make your text as
                            ...
                            <Row>
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <h4 className='card-title mb-2'>
                                                A day in the of a professional
                                                fashion designer
                                            </h4>
                                            <p className='card-text text-muted'>
                                                {' '}
                                                Exercitation +1 labore velit,
                                                blog sartorial PBR leggings next
                                                level wes anderson artisan four
                                                loko farm-to-table craft beer
                                                twee. commodo enim craft beer
                                            ...
                                            <Col md={8}>
                                                ...
                                                <CardBody>
                                                    <p className='card-text mb-2'>
                                                        ...
                                                        designers and asked them
                                                        what graphic design tips
                                                        they live.
                                                    </p>
                                                    <p className='card-text'>
                                    ...
                                    <div className='d-flex align-items-center'>
                                        ...
                                        <div className='flex-grow-1 ms-3'>
                                            <p className='card-text'>
                                                ...
                                                (Graphic Designer) started a new
                                                conversation.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <Row>
                                <Col xxl={4}>
                                    <Card className='border card-border-primary'>
                                        ...
                                        <CardBody>
                                            <p className='card-text'>
                                                Whether article spirits new her
                                                covered hastily sitting her.
                                                Money witty books nor son add
                                                build on the card Chicken age
                                                had evening believe but proceed
                                                pretend mrs.
                                            </p>
                                            <div className='text-end'>
                                                <Link
                            ...
                            <Card className='border card-border-warning'>
                                ...
                                <CardBody>
                                    <p className='card-text'>
                                        ...
                                        graphic. Cosby sweater eu banh mi, qui
                                        irure terry richardson ex squid.
                                    </p>
                                    <div className='text-end'>
                                        <Link
                                            to='#'
                                            className='link-warning fw-medium'
                                        >
                                            Read More{' '}
                                            <i className='ri-arrow-right-line align-middle'></i>
                                        </Link>
                            ...
                            <Card className='border card-border-danger'>
                                ...
                                <CardBody>
                                    ...
                                    <div className='text-end'>
                                        <Link
                                            to='#'
                                            className='link-danger fw-medium'
                                        >
                                            Read More{' '}
                                            <i className='ri-arrow-right-line align-middle'></i>
                                        </Link>
                            ...
                            <Card className='h-100'>
                                ...
                                <CardBody>
                                    <p className='card-text'>
                                        ...
                                        encountered tip I received from the
                                        designers I spoke with. They highly
                                        encourage that you use different fonts
                                        in one design, but do not
                                        over-exaggerate and go overboard.
                                    </p>
                                </CardBody>
                                <div className='card-footer'>
                            ...
                            <Card className='h-100'>
                                ...
                                <CardBody>
                                    ...
                                    <p className='card-text'>
                                        ...
                                        craft beer twee. ommodo enim craft beer
                                    ...
                                    <Col>
                                        <Card>
                                            <CardBody>
                                                ...
                                                <p className='card-text text-muted'>
                                                    {' '}
                                                    Exercitation +1 labore
                                                    velit, blog sartorial PBR
                                                    leggings next level wes
                                    ...
                                    <div>
                                        <Card>
                                            <CardBody>
                                                ...
                                                <p className='card-text'>
                                                    This is another card with
                                                    title and supporting text
                                                    below. This card has some
                                                    additional content to make
                                    ...
                                    <div>
                                        <Card className='text-center'>
                                            <CardBody>
                                                ...
                                                <p className='card-text'>
                                                    This card has a regular
                                                    title and short paragraphy
                                                    of text below it.
                                                </p>
                                                <p className='card-text'>
                                                    <small className='text-muted'>
                                            ...
                                            <div className='d-flex position-relative'>
                                                ...
                                                <div>
                                                    ...
                                                    <p>
                                                        ...
                                                        content for the custom
                                                        component. It is
                                                        intended to mimic what
                                                        some real-world content
                                                        would look like, and
                                                        we're using it here to
                                                        give the component a bit
                                                        of body and size.
                                                    </p>
                                                    <Link
                                                        to='#'
