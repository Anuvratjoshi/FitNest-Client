                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        In the example below, we take a typical
                                        card component and recreate it with
                                        placeholders applied to create a
                                        “loading card”.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>w-100</code> class to placeholder
                                        class to set different widths to the
                                        placeholder.
                                    </p>
                                    <div className='live-preview'>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>placeholder-xs</code> class to
                                        placeholder class to set different size
                                        placeholder.
                                    </p>
                                    <div className='live-preview'>
                                        <Row className='gap-0'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>bg-</code> class with the
