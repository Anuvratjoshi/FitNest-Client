                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use<code> btn</code> class at to create
                                        a dropdown toggle with &lt;button&gt;
                                        element.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>btn-</code> class with below
                                        mentioned variation to color dropdown
                                        toggle.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-3'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>divider</code> attribute to
                                        DropdownItem to create split button
                                        dropdowns as a single button
                                        dropdown.{' '}
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-3'>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        a large size dropdown button and{' '}
                                        <code>btn-sm</code> to create a small
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>dropdown-menu-dark</code>{' '}
                                        class onto an existing dropdown-menu to
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Example of dropdown menu and dropdown
                                        item color.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>Headers, Text and Forms</code>{' '}
                                        content.
                                    </p>
                                    <div className='live-preview'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Dropdown with notification containing
                                        multiple tabs.
                                    </p>
                                    <div className='live-preview'>
                                        <Row className='g-3'>
