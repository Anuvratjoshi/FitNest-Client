                                        ...
                                        <Row>
                                            <Col sm={6}>
                                                <div className='text-muted'>
                                                    ...
                                                    <div>
                                                        <p className='display-4 text-body fw-medium'>
                                                            Aa
                                                        </p>
                                                    </div>
                                                    <div>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        class for quoting blocks of content from
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted text-muted'>
                                        Use <code>blockquote-</code> class with
                                        the below-mentioned color variation to
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted text-muted'>
                                        Use <code>blockquote-outline</code>{' '}
                                        class to set blockquote border color.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='row gy-4'>
                                            <div className='col-xl-4 col-md-6'>
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>list-unstyled</code> class
                                        Remove the default list-style and left
                                        margin on list items (immediate children
                                        only).{' '}
                                        <strong>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code> list-inline-item</code> class
                                        combination to remove a list’s bullets
                                        and apply some light margin.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        For longer terms, you can optionally add
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className='live-preview'>
                                        ...
                                        <div className='mt-4'>
                                            <p className='text-muted'>
                                                Use <code>text-nowrap</code>{' '}
                                                class to prevent text from
                                                wrapping.
                                            </p>
                                            <div
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className='live-preview'>
                                        <div>
                                            <p className='text-muted'>
                                                Use <code>text-break</code>{' '}
                                                class to prevent long strings of
                                                text from breaking your
                                                components' layout.
                                            </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>fs-5</code>, or <code>fs-6</code>,
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>fst-</code>with modifier class
                                        to change font-style and Use{' '}
                                        <code>fw-</code>with modifier class to
                                        change font-weight.
                                    </p>
                                    ...
                                    <div className='live-preview'>
                                        ...
                                        <p className='fw-bolder'>
                                            Bolder weight text (relative to the
                                            parent element).
                                        </p>
                                        ...
                                        <p className='fw-lighter'>
                                            Lighter weight text (relative to the
                                            parent element).
                                        </p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>lh-</code> with modifier class
                                        to change the line height of an element.
                                    </p>

                                    <div className='live-preview'>
                                        <p className='lh-1'>
                                            This is a long paragraph written to
                                            show how the line-height of an
                                            element is affected by our
                                            utilities. Classes are applied to
                                            the element itself or sometimes the
                                            parent element. These classes can be
                                            customized as needed with our
                                            utility API.
                                        </p>
                                        <p className='lh-sm'>
                                            This is a long paragraph written to
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        , or <code>text-decoration-none</code>{' '}
                                        class to decorate text in components
                                        respectively.
                                    </p>
                                    <div className='live-preview'>
                                        ...
                                        <p className='text-decoration-line-through'>
                                            This text has a line going through
                                            it.
                                        </p>
                                        <Link
                                            to='#'
                                        ...
                                        >
                                            This link has its text decoration
                                            removed
                                        </Link>
                                    </div>
                                    <div className='d-none code-view'>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>text-truncate</code> class to
                                        truncate the text with an ellipsis.
                                        Requires{' '}
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>visible</code> or{' '}
                                        <code>invisible</code> class to show or
                                        to hide elements respectively.
                                    </p>

                                    <div className='live-preview'>
                                        <div className='visible'>
                                            text visible Lorem ipsum dolor sit
                                            amet
                                        </div>
                                        <div className='invisible'>
                                            text invisible Lorem ipsum dolor sit
                                            amet
                                        </div>
                                    </div>
                                    <div className='d-none code-view'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>clearfix</code> class to
                                        clear/set floated content within a
                                        container.
                                    </p>
                                    <div className='live-preview'>
