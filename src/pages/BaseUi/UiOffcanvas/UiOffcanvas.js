                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>offcanvas</code> class to
                                        set a default offcanvas.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>direction="end"</code>, to
                                        offcanvas attribute to set different
                                        Offcanvas Placement.
                                    </p>
                                    <div className='live-preview'>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Here are the example of offcanvas with
                                        scrolling active and backdrop visible.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex flex-wrap gap-2'>
                                            <Button
                                ...
                                <div className='acitivity-item py-3 d-flex'>
                                    ...
                                    <div className='flex-grow-1 ms-3'>
                                        ...
                                        <p className='text-muted mb-2'>
                                            ...
                                            beyond the words on the page. They
                                            can come across as casual or
