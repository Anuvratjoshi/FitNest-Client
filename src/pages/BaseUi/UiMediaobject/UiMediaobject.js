                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-4'>
                                        Use few flex utilities that allow even
                                        more flexibility and customization than
                                        before.
                                    </p>
                                    ...
                                    <div className='live-preview'>
                                        <div className='d-flex align-items-start text-muted mb-4'>
                                            ...
                                            <div className='flex-grow-1'>
                                                ...
                                                media component. You can replace
                                                this with any content and adjust
                                                it as needed.
                                            </div>
                                        </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-4'>
                                        Media objects can be infinitely nested,
                                        though we suggest you stop at some
                                        point. Place nested{' '}
                                        <code>d-flex align-items-start</code>{' '}
                                        within the <code>flex-grow-1</code> of a
                                        parent media object.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='d-flex align-items-start text-muted mb-4'>
                                    ...
                                    <div className='live-preview'>
                                        <div className='d-flex align-items-start text-muted mb-4'>
                                            ...
                                            <div className='flex-grow-1'>
                                                ...
                                                <p className='mb-0'>
                                                    Donec sed odio dui. Nullam
                                                    quis risus eget urna mollis
                                                    ornare vel eu leo. Cum
