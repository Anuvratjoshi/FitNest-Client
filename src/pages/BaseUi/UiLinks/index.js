                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        You can use the <code>.link-*</code>{' '}
                                        ...
                                        <code>:hover</code> and{' '}
                                        <code>:focus</code> state. Some of the
                                        link styles use a relatively light
                                        foreground color, and should only be
                                        used on a dark background in order to
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Colored links can also be modified by
                                        our link utilities.
                                    </p>
                                    <div className='live-preview'>
                                        <p>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>rgba()</code> color value with
                                        utilities. Please be aware that changes
                                        to a color’s opacity can lead to links
                                        with{' '}
                                        <a
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>tag="NavLink"</code> to create
                    ...
                    <Row>
                        <Col xxl={4}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Change the underline’s color independent
                                        of the link text color.
                                    </p>
                                    <div className='live-preview'>
                                        <p>
                                            <a
                        ...
                        <Col xxl={4}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Change the underline’s opacity. Requires
                                        adding <code>.link-underline</code> to
                                        first set an <code>rgba()</code> color
                        ...
                        <Col xxl={4}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Change the underline’s distance from
                                        your text. Offset is set in{' '}
                                        <code>em</code> units to automatically
                                        scale with the element’s current{' '}
                                        <code>font-size</code>.
                                    </p>
                                    <div className='live-preview'>
                                        <p>
