                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        attribute to progress bar class with the
                                        below-mentioned color variation to set
                                        the background color progress bar.
                                    </p>
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Multiple bar color to change the
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>progress-xl</code> class to set
                                        the different heights of progress.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='mb-4'>
                                            <h5 className='fs-13'>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>striped</code> attribute to
                                        add strip to the progress.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='mb-4'>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>striped animated</code>{' '}
                                        attribute to add strip with animation to
                                        the progress.
                                    </p>
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>animated-progess</code> class
                                        to show progress with animation.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='mb-4'>
                                            <Progress
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use{' '}
                                        <code>
                                            animated-progess custom-progess{' '}
                                        </code>{' '}
                                        class to show custom progress with
                                        animation.
                                    </p>
                                    <div className='live-preview'>
                                        <div className='mb-4'>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted pb-2'>
                                        Example of progress with content wrapped
                                        in progress.
                                    </p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted pb-2'>
                                        Here is the example of progress which is
                                        represented by steps completion.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted pb-2'>
                                        Use <code>progress-step-arrow </code>
                                        class to create step progress with an
                                        arrow.
                                    </p>
