                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Wrap any embed in
                                        <code>&lt;iframe&gt;</code> tag, in a
                                        parent element, use{' '}
                                        <code>ratio-16x9</code> class to set
                                        aspect ratio 16:9.{' '}
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>ratio-4x3</code> class to set
                                        aspect ratio 4:3.
                                    </p>
                                    <div className='live-preview'>
                                        {/* <!-- 4:3 aspect ratio --> */}
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>--vz-aspect-ratio: 50%</code>{' '}
                                        to style element to set aspect ratio
                                        2:1.
                                    </p>
                                    <div className='live-preview'>
                                        {/* <!-- 16:9 aspect ratio --> */}
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>ratio-21x9</code> class to set
                                        aspect ratio 21:9.
                                    </p>
                                    <div className='live-preview'>
                                        {/* <!-- 21:9 aspect ratio --> */}
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>ratio-1x1</code> class to set
                                        aspect ratio 1:1.
                                    </p>{' '}
                                    <div className='live-preview'>
                                        {/* <!-- 1:1 aspect ratio --> */}
