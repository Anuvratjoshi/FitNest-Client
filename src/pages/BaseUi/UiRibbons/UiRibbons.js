                                    ...
                                    <div className='live-preview'>
                                        <Row className='g-3'>
                                            <p className='text-muted'>
                                                Use <code>round-shape</code>{' '}
                                                class to show round-shaped
                                                ribbon.
                                            </p>
                                            <Col xxl={4}>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className='live-preview'>
                                        <Row className='g-3'>
                                            <p className='text-muted'>
                                                Use <code>ribbon-shape</code>{' '}
                                                class to show ribbon shaped
                                                ribbon.
                                            </p>
                                            <Col xxl={4}>
                                                <div className='card ribbon-box border shadow-none mb-lg-0'>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className='live-preview'>
                                        <Row className='g-3'>
                                            <p className='text-muted'>
                                                Use <code>ribbon-fill</code>{' '}
                                                class to show fill-shaped
                                                ribbon.
                                            </p>
                                            <Col xxl={4}>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className='live-preview'>
                                        <Row className='g-3'>
                                            <p className='text-muted'>
                                                Use <code>ribbon-box</code>{' '}
                                                class with{' '}
                                                <code>ribbon-two</code> class at
                                                child element to show
                                    ...
                                    <div className='live-preview'>
                                        <Row className='g-3'>
                                            <p className='text-muted'>
                                                Use <code>ribbon-box</code>{' '}
                                                class with{' '}
                                                <code>ribbon-three</code> class
                                                at child element to show
                                                below-mentioned shaped ribbon.
                                            </p>
                                            <Col xxl={4}>
                                                <div className='card ribbon-box border shadow-none mb-lg-0'>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className='live-preview'>
                                        <Row className='g-3'>
                                            <p className='text-muted'>
                                                Use <code>trending-ribbon</code>{' '}
                                                class to show ribbon with
                                                hovering effect.
                                            </p>
                                            <Col xxl={4}>
