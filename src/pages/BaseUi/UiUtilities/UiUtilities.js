                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        element’s borders. Choose from all
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use below-mentioned class to an element
                                        to easily round its corners.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
                                            <div>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use below-mentioned class to an element
                                        to display the value of components and
                                        more with our display utilities.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
                                            <Row>
                                        ...
                                        <div className='mt-4'>
                                            ...
                                            <p className='text-muted'>
                                                Change the display value of
                                                elements when printing with our
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the below-mentioned class to an
                                        element to custom display the value of
                                        components and more with our display
                                        utilities.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-3'>
                                        Use <code>vstack</code> class to create
                                        vertical layouts. Stacked items are
                                        full-width by default. Use{' '}
                                        <code>gap-</code> class with variation
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-3'>
                                        Use <code>hstack</code> class to create
                                        horizontal layouts. Stacked items are
                                        full-width by default. Use{' '}
                                        <code>gap-</code> class with variation
                                        to add space between items.
                                    </p>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-3'>
                                        ...
                                        <code>user-select-none</code> class to
                                        the content which is selected when the
                                    ...
                                    <div className='live-preview'>
                                        <div>
                                            <p className='user-select-all'>
                                                This paragraph will be entirely
                                                selected when clicked by the
                                                user.
                                            </p>
                                            ...
                                            <p className='user-select-none mb-0'>
                                                ...
                                                selectable when clicked by the
                                                user.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-3'>
                                        Use <code>pe-none</code> class to
                                        prevent and
                                        <code>pe-auto</code> class to add
                                        element interactions respectively.
                                    </p>
                                    ...
                                    <div className='live-preview'>
                                        <div>
                                            ...
                                            <p>
                                                <Link
                                                    to='#'
                                                    className='text-success pe-auto'
                                                >
                                                    This link
                                                </Link>{' '}
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>overflow</code> property on
                                        the fly with four default values and
                                        classes.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        While shadows on components are disabled
                                        by default in Bootstrap and can be
                                        enabled via <code>$enable-shadows</code>
                                        , you can also quickly add or remove a
                                        shadow with our <code>box-shadow</code>{' '}
                                        utility classes. Includes support for{' '}
                                        <code>.shadow-none</code> and three
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>w-25</code>,<code>w-50</code>,
                                        <code>w-75</code>,<code>w-100</code> or{' '}
                                    ...
                                    <div className='live-preview'>
                                        <div>
                                            ...
                                            <div className='w-50 p-3 bg-light'>
                                                Width 50%
                                            </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>h-25</code>,<code>h-50</code>,
                                        <code>h-75</code>,<code>h-100</code> or{' '}
                                    ...
                                    <div className='live-preview'>
                                        ...
                                        >
                                            <Col className='col'>
                                                <div className='h-25 p-3 bg-light'>
                                                    Height25%
                                                </div>
                                            </Col>
                                            <Col className='col'>
                                                <div className='h-50 p-3 bg-light'>
                                                    Height 50%
                                                </div>
                                            </Col>
                                            <Col className='col'>
                                                <div className='h-75 p-3 bg-light'>
                                                    Height 75%
                                                </div>
                                            </Col>
                                            <Col className='col'>
                                            ...
                                            <Col className='col'>
                                                <div className='h-auto p-3 bg-light'>
                                                    Height auto
                                                </div>
                                            </Col>
                                        </div>
