                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>Alert</code> tag to show a
                                        default alert.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>border-0</code> class to
                                        set alert without border.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>UncontrolledAlert</code>{' '}
                                        tag to add dismissing button to the
                                        alert.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>alert-link</code> class at
                                        &lt;a&gt; tag to show matching colored
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Click the Show live alert button to show
                                        an alert on button click.
                                    </p>
                                    <div className='live-preview'>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the{' '}
                                        <code>border-2 bg-body-secondary</code>{' '}
                                        class to set an alert with outline.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>alert-border-left </code>{' '}
                                        class to set an alert with the left
                                        border.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>alert-label-icon</code>{' '}
                                        class to set an alert with a label icon.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert
                                                    color='primary'
                                                    className='alert-solid alert-label-icon bg-primary text-white'
                                                ...
                                                <UncontrolledAlert
                                                    color='secondary'
                                                    className='alert-solid alert-label-icon bg-secondary text-white'
                                                    closeClassName='btn-close-white'
                                                >
                                                ...
                                                <UncontrolledAlert
                                                    color='success'
                                                    className='alert-solid alert-label-icon bg-success text-white'
                                                    closeClassName='btn-close-white'
                                                >
                                                ...
                                                <UncontrolledAlert
                                                    color='danger'
                                                    className='alert-solid alert-label-icon mb-xl-0 bg-danger text-white'
                                                    closeClassName='btn-close-white'
                                                >
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert
                                                    color='warning'
                                                    className='alert-solid alert-label-icon bg-warning text-white'
                                                    closeClassName='btn-close-white'
                                                >
                                                ...
                                                <UncontrolledAlert
                                                    color='info'
                                                    className='alert-solid alert-label-icon bg-info text-white'
                                                    closeClassName='btn-close-white'
                                                >
                                                ...
                                                <UncontrolledAlert
                                                    color='light'
                                                    className='alert-solid alert-label-icon bg-light text-body'
                                                    closeClassName='btn-close-white'
                                                >
                                                ...
                                                <UncontrolledAlert
                                                    color='dark'
                                                    className='alert-solid alert-label-icon mb-0 bg-dark text-white'
                                                    closeClassName='btn-close-white'
                                                >
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>alert-additional</code>{' '}
                                        class and Use the <code>alert-</code>{' '}
                                        class to HTML elements like headings,
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>alert-top-border</code>{' '}
                                        class to set an alert with the top
                                        border and outline.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        class to show an alert with label icon
                                        and arrow.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the{' '}
                                        <code>
                                            alert-label-icon rounded-label
                                        </code>{' '}
                                        class to set an alert with a rounded
                                        label icon.
                                    </p>
                                    <div className='live-preview'>
                                        <Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use the <code>bg-*</code>,{' '}
                                        <code>border-*</code> &{' '}
                                        <code>text-white</code> class to set an
                                        alert with solid style.
                                    </p>
                                    ...
                                    <div className='live-preview'>
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <Alert
                                                    color='primary'
                                                    className='alert-solid bg-primary text-white'
                                                >
                                                ...
                                                <Alert
                                                    color='secondary'
                                                    className='alert-solid bg-secondary text-white'
                                                >
                                                    <strong>
                                                        How are you!
                                                    </strong>{' '}
                                                ...
                                                <Alert
                                                    color='success'
                                                    className='alert-solid bg-success text-white'
                                                >
                                                    <strong>
                                                        Yey! Everything
                                                        worked!{' '}
                                                    </strong>{' '}
                                                    - Solid <b>success alert</b>{' '}
                                                    example
                                                </Alert>
                                                ...
                                                <Alert
                                                    color='danger'
                                                    className='alert-solid bg-danger text-white mb-xl-0'
                                                >
                                                    <strong>
                                                        Something is very wrong!
                                                    </strong>{' '}
                                                    - Solid <b>danger alert</b>{' '}
                                                    example
                                                </Alert>
                                            </Col>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <Alert
                                                    color='warning'
                                                    className='alert-solid bg-warning text-white'
                                                >
                                                    <strong>
                                                        Uh oh, something went
                                                        wrong!
                                                    </strong>{' '}
                                                    - Solid <b>warning alert</b>{' '}
                                                    example
                                                </Alert>
                                                ...
                                                <Alert
                                                    color='info'
                                                    className='alert-solid bg-info text-white'
                                                >
                                                    <strong>
                                                        Don't forget' it !
                                                    </strong>{' '}
                                                    - Solid <b>info alert</b>{' '}
                                                    example
                                                </Alert>
                                                ...
                                                <Alert
                                                    color='light'
                                                    className='alert-solid bg-light text-body'
                                                >
                                                    <strong>
                                                        Mind Your Step!
                                                    </strong>{' '}
                                                ...
                                                <Alert
                                                    color='dark'
                                                    className='alert-solid bg-dark text-white mb-0'
                                                >
                                                    <strong>
                                                        Did you know?
                                                    </strong>{' '}
                                                    - Solid <b>dark alert</b>{' '}
                                                    example
                                                </Alert>
                                            </Col>
                                        </Row>
