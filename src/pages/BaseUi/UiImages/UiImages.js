                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>rounded-circle</code> class to
                                        show an image with a round border and
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>img-thumbnail</code> class to
                                        give an image rounded 1px border
                                        appearance.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted mb-4'>
                                        Use <code>avatar-xxs</code>,{' '}
                                        <code>avatar-xs</code>,{' '}
                                        <code>avatar-sm</code>,{' '}
                                        <code>avatar-md</code>,{' '}
                                        <code>avatar-lg</code>,{' '}
                                        <code>avatar-xl</code> class for
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='card-title-desc text-muted'>
                                        ...
                                        <code>figure-caption</code> classes to
                                        provide some baseline styles for the
                                        HTML5 <code>&lt;figure&gt;</code> and{' '}
