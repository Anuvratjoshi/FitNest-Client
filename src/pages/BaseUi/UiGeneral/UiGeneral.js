                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Popovers example are available with
                                        follwing options , Directions are
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Tooltip example are available with
                                        follwing options, Directions are
                                        mirrored when using Bootstrap in RTL.
                                    </p>
                                    <div className='live-preview'>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                ...
                                                <p className='text-muted'>
                                                    ...
                                                    attribute to ul element to
                                                    indicate a series of related
                                            ...
                                            <Col lg={6}>
                                                <div className='mt-4 mt-lg-0'>
                                                    ...
                                                    <p className='text-muted'>
                                                        ...
                                                        <code>disabled</code>{' '}
                                                        attribute to
                                                        PaginationItem to links
                                                        that appear un-clickable
                                                        and <code>active</code>{' '}
                                                        class to indicate the
                                                        current page.
                                                    </p>
                                                    <Pagination>
                                                        <PaginationItem
                                            ...
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <p className='text-muted'>
                                                        ...
                                                        class for a lightweight
                                                        spinner with growing
                                                        effect.
                                                    </p>
                                                    <div className='d-flex flex-wrap gap-3 mb-2'>
                                                        {/* <!-- Growing spinner --> */}
