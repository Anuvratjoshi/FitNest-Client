                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>ListGroup</code> attribute in
                                        an unordered list and{' '}
                                        <code>ListGroupItem</code> attribute to
                                    ...
                                    <div className='live-preview'>
                                        <ListGroup>
                                            ...
                                            <ListGroupItem>
                                                ...
                                                Meeting with daron to review the
                                                intake form
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className='ri-secure-payment-line align-middle me-2'></i>
                                                Check uikings theme and give
                                                customer support
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>ListGroupItem</code> to indicate
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        <code>ListGroupItem</code> to make it{' '}
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>tag="a"</code> to create
                                        actionable list group items with hover,
                                    ...
                                    <div className='live-preview'>
                                        <ListGroup className='list-group-fill-success'>
                                            ...
                                            <ListGroupItem
                                                ...
                                                tabIndex='-1'
                                            >
                                                <i className='ri-moon-fill align-middle me-2'></i>
                                                Dark Mode
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>tag="button"</code> to create
                                        actionable list group items with hover,
                                        disabled, and active states by adding
                                        list-group-item-action.
                                    </p>
                                    <div className='live-preview'>
                                        <ListGroup>
                                            <ListGroupItem
                                                ...
                                                className='list-group-item-action active'
                                            >
                                                <i className='ri-reply-fill align-middle me-2'></i>
                                                Reply
                                            </ListGroupItem>
                                            <ListGroupItem
                                                tag='button'
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>flush</code> attribute to
                                        ListGroup to remove some borders and
                                        rounded corners to render list group
                                        items.
                                    </p>
                                    <div className='live-preview'>
                                        <ListGroup flush>
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>horizontal</code> attribute to
                                        ListGroup to change the layout of list
                                        group items from vertical to horizontal
                    ...
                    <Row>
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>color="Required color"</code>{' '}
                                        to style list items with a stateful
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        link. Note the addition of the hover
                                        styles here not present in the previous
                                        example.
                                    </p>
                                    <div className='live-preview'>
                                        <ListGroup>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>list-group-fill-</code> with
                                        modifier class to style list items with
                                        a stateful background and color.
                                    </p>
                                    <div className='live-preview'>
                                        <ListGroup>
                                            <ListGroupItem>
                                        ...
                                        <ListGroup>
                                            ...
                                            >
                                                ...
                                                <p className='list-text mb-0'>
                                                    ...
                                                    confound zany experimental
                                                    vow. My girl wove six dozen
                                                    plaid jackets before she
                                                    quit. Six big devils from
                                                    Japan quickly forgot how to
                                                    waltz. try again until it
                                                    looks right, and each
                                                    assumenda labore aes Homo
                                                    nostrud organic, assumenda
                    ...
                    <Row>
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use badges to any list group item to
                                        show unread counts, activity, and more
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use Bootstrap’s checkboxes within list
                                        group items and customize as
                                        needed.{' '}
                                    </p>
                                    <div className='live-preview'>
                                        <ListGroup>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use Bootstrap’s radios within list group
                                        items and customize as needed.{' '}
                                    </p>
                                    <div className='live-preview'>
                                        <ListGroup>
                                            <ListGroupItem tag='label'>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use icons to any list group item to show
                                        icons to list group items.
                                    </p>
                                    <div className='live-preview'>
                                        <ListGroup>
                                            <ListGroupItem>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>list-group-numbered</code>{' '}
                                        class (optionally use an{' '}
                                        <code>&lt;ol&gt;</code> element) to show
