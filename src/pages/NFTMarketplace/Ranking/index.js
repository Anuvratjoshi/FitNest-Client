        ...
        () => [
            ...
            },
            {
                ...
                Cell: cell => {
                    if (cell.value > 0) {
                        return (
                            <h6 className='text-success mb-1 24h'>
                                {' '}
                                {cell.value} ETH
                            </h6>
                        )
                        ...
                        return (
                            <h6 className='text-danger mb-1 24h'>
                                {cell.value} ETH
                            </h6>
                        )
                    }
            ...
            },
            {
                ...
                Cell: cell => {
                    if (cell.value > 0) {
                        return (
                            <h6 className='text-success mb-1 7d'>
                                {' '}
                                {cell.value} ETH
                            </h6>
                        )
                        ...
                        return (
                            <h6 className='text-danger mb-1 7d'>
                                {cell.value} ETH
                            </h6>
                        )
                    }
