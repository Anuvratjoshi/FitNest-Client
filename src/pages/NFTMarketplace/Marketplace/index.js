                    ...
                    <Row>
                        ...
                        <Col xl={4}>
                            <div className='alert alert-danger'>
                                Up to <b>50% OFF</b>, Hurry up before the stock
                                ends
                            </div>
                            <Card
                            ...
                            >
                                <CardBody className='p-4'>
                                    ...
                                    <h3 className='text-white lh-base'>
                                        Discover, Collect, Sell and Create your
                                        own NFT
                                    </h3>
                                    <p className='text-white text-opacity-75 mb-3'>
                                        Take advantage of the first text-based
                                        NFT. Select a text or write your own and
                                        let it live forever on the Ethereum
                                        blockchain you or future owners can add
                            ...
                            <Card className='overflow-hidden shadow-none border-0'>
                                <CardBody className='bg-primary-subtle text-primary fw-semibold d-flex'>
                                    <div className='marquee'>
                                        <div>
                                            <span>
                                                NFT art is a digital asset that
                                                is collectable, unique, and
                                                non-transferrable, Cortes
                                                explained. Every NFT is unique
                                                in it's creative design and
                                                cannot be duplicated, making
                                                them limited and rare. NFTs get
                                                their value because the
                                                transaction proves ownership of
                                                the art.
                                            </span>
                                            <span>
                                                NFT art is a digital asset that
