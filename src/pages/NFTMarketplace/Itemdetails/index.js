                                    ...
                                    <div className='sticky-side-div'>
                                        <Card className='ribbon-box border shadow-none right'>
                                            <div className='ribbon-two ribbon-two-danger'>
                                                <span>
                                                    <i className='ri-fire-fill align-bottom'></i>{' '}
                                                    Hot
                                                </span>
                                            </div>
                                            <img
                                ...
                                <Col lg={8}>
                                    <div>
                                        ...
                                        <span className='badge bg-primary-subtle text-primary mb-3 fs-12'>
                                            <i className='ri-eye-line me-1 align-bottom'></i>{' '}
                                                ...
                                                <div className='p-2 border border-dashed rounded text-center'>
                                                    <div>
                                                        ...
                                                        <h5 className='fs-17 text-primary mb-0'>
                                                            <i className='mdi mdi-ethereum me-1'></i>{' '}
                                                            83.06 ETH
                                                        </h5>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table className='table mb-0'>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        E545D145S5646544DS541SFDB213C5Z
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
