                        ...
                        <CardBody>
                            <div className='text-muted'>
                                ...
                                <p>
                                    ...
                                    vocabulary. The languages only differ in
                                ...
                                <ul className='ps-4 vstack gap-2'>
                                    ...
                                    <li>
                                        Create calendar, chat and email app
                                        pages.
                                    </li>
                                ...
                                <div className='d-flex mb-4'>
                                    ...
                                    <div className='flex-grow-1 ms-3'>
                                        ...
                                        <p className='text-muted'>
                                            ...
                                            that when they place order always
                                            get error message .
                                        </p>
                                        <Link
                                            to='#'
                                ...
                                <div className='d-flex mb-4'>
                                    ...
                                    <div className='flex-grow-1 ms-3'>
                                        ...
                                        <p className='text-muted'>
                                            ...
                                            please contact Customer Support from
                                            the “Action Menu” on your{' '}
                                            <Link
                                                to='#'
                                ...
                                <div className='d-flex'>
                                    ...
                                    <div className='flex-grow-1 ms-3'>
                                        ...
                                        <p className='text-muted'>
                                            ...
                                            your order refer to the “Action
                                            Menu” to initiate return, contact
