                    ...
                    >
                        <div className='mail-list mt-3'>
                            ...
                            <Link
                                ...
                                className={
                                    activeTabs === 'starred' ? 'active' : null
                                }
                            >
                            ...
                            <Link
                                ...
                                className={
                                    activeTabs === 'important' ? 'active' : null
                                }
                            >
                                ...
                                <UncontrolledCollapse toggler='#email-collapseOne'>
                                    <div className='accordion-body text-body px-0'>
                                        <div>
                                            <p>Hi,</p>
                                            <p>
                                                Praesent dui ex, dapibus eget
                                                mauris ut, finibus vestibulum
                                                enim. Quisque arcu leo,
                                                facilisis in fringilla id,
                                                luctus in tortor.
                                            </p>
                                            <p>
                                                Sed elementum turpis eu lorem
                                                interdum, sed porttitor eros
                                                commodo. Nam eu venenatis
                                                tortor, id lacinia diam. Sed
                                                aliquam in dui et porta. Sed
                                                bibendum orci non tincidunt
                                                ultrices.
                                            </p>
                                            <p>Sincerly,</p>
