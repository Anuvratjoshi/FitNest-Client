                        ...
                        <Card className='card-height-100'>
                            ...
                            <div className='card-body p-0'>
                                <div>
                                    <CountriesCharts
                                        series={countryData}
                                        dataColors='["--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4"]'
                                    />
                                </div>
                            </div>
                        </Card>
