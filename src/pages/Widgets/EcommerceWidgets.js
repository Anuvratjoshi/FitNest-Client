                    ...
                    <Card className='card-height-100'>
                        <CardBody>
                            ...
                            <p className='text-muted pb-1'>
                                If you couldn't relate to the information in the
                                previous point, you might be looking for the
                                singlet T-shirt, which is also known as the half
                                T-shirt.
                            </p>
                            ...
                            <Link
                                to='#!'
                                className='btn btn-soft-danger d-block'
                            >
                                Add to Cart
                            </Link>
                        </CardBody>
                        ...
                        <Row className='g-0'>
                            <Col lg={6}>
                                <CardBody className='border-end'>
                                    ...
                                    >
                                        <ul
                                            className='list-unstyled mb-0 pt-2'
                                            id='candidate-list'
                                        >
                                            <li>
                                                <Link
