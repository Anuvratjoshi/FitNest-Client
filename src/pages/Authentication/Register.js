...
const Register = () => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      ownersFirstName: Yup.string().required("Please Enter Your First Name"),
      ownersLastName: Yup.string().required("Please Enter Your Last Name"),
      ownersNationality: Yup.string().required("Please Enter Your Nationality"),
      ownersNumber: Yup.string().required("Please Enter Your Phone number"),
                  ...
                  <CardBody className="p-4">
                    <div className="text-center mt-2">
                      ...
                      <p className="text-muted">
                        Get your free FitNest account now
                      </p>
                    </div>
                          ...
                          <Col md={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                onChange={validation.handleChange}
                                onBlur={validation.handleBlur}
                                value={validation.values.ownersFirstName}
                                invalid={
                                  validation.touched.ownersFirstName &&
                                  !!validation.errors.ownersFirstName
                                }
                              />
                              {validation.touched.ownersFirstName &&
                                validation.errors.ownersFirstName && (
                          ...
                          <Col md={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                onChange={validation.handleChange}
                                onBlur={validation.handleBlur}
                                value={validation.values.ownersLastName}
                                invalid={
                                  validation.touched.ownersLastName &&
                                  !!validation.errors.ownersLastName
                                }
                              />
                              {validation.touched.ownersLastName &&
                                validation.errors.ownersLastName && (
                          ...
                          <Col md={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                onChange={validation.handleChange}
                                onBlur={validation.handleBlur}
                                value={validation.values.ownersNationality}
                                invalid={
                                  validation.touched.ownersNationality &&
                                  !!validation.errors.ownersNationality
                                }
                              />
                              {validation.touched.ownersNationality &&
                                validation.errors.ownersNationality && (
                          ...
                          <Col md={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                onChange={validation.handleChange}
                                onBlur={validation.handleBlur}
                                value={validation.values.ownersNumber}
                                invalid={
                                  validation.touched.ownersNumber &&
                                  !!validation.errors.ownersNumber
                                }
                              />
                              {validation.touched.ownersNumber &&
                                validation.errors.ownersNumber && (
                          ...
                          <Col md={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                onChange={validation.handleChange}
                                onBlur={validation.handleBlur}
                                value={validation.values.gymLocation}
                                invalid={
                                  validation.touched.gymLocation &&
                                  !!validation.errors.gymLocation
                                }
                              />
                              {validation.touched.gymLocation &&
                                validation.errors.gymLocation && (
                          ...
                          <Col md={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                onChange={validation.handleChange}
                                onBlur={validation.handleBlur}
                                value={validation.values.gymName}
                                invalid={
                                  validation.touched.gymName &&
                                  !!validation.errors.gymName
                                }
                              />
                              {validation.touched.gymName &&
                                validation.errors.gymName && (
