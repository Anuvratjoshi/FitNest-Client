...
const PrivacyPolicy = () => {
    document.title =
        'Privacy Policy | Velzon - React Admin & Dashboard Template'
    return (
        <React.Fragment>
                            ...
                            <Card>
                                ...
                                <CardBody className='p-4'>
                                    <div className='d-flex'>
                                        ...
                                        <div className='flex-grow-1'>
                                            ...
                                            <p className='text-muted'>
                                                ...
                                                Website.com, one of our main
                                                priorities is the privacy of our
                                                visitors. This Privacy Policy
                                                document contains types of
                                                information that is collected
                                                and recorded by Website Name and
                                                how we use it.
                                            </p>
                                            <p className='text-muted'>
                                            ...
                                            <p className='text-muted'>
                                                ...
                                                to our online activities and is
                                                valid for visitors to our
                                    ...
                                    <div className='d-flex'>
                                        ...
                                        <div className='flex-grow-1'>
                                            <p className='text-muted'>
                                                Some of advertisers on our site
                                                may use cookies and web beacons.
                                                Our advertising partners are
                                                listed below. Each of our
                                                advertising partners has their
                                                own Privacy Policy for their
                                                policies on user data. For
                                                easier access, we hyperlinked to
                                                their Privacy Policies below.
                                            </p>
                                            <p className='text-muted'>
                                                <b>
                                                    Website Name's Privacy
                                                    Policy does not apply to
                                                    other advertisers or
                                                    websites. Thus, we are
                                                    advising you to consult the
                                                    respective Privacy Policies
                                                    of these third-party ad
                                                    servers for more detailed
                                                    information. It may include
                                                    their practices and
                                                    instructions about how to
                                                    opt-out of certain options.
                                                    You may find a complete list
                                                    of these Privacy Policies
