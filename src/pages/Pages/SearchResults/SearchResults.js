...
const SearchResults = () => {
    ...
    document.title =
        'Search Results | Velzon - React Admin & Dashboard Template'
                                        ...
                                        <TabPane tabId='1'>
                                            <div className='pb-3'>
                                                ...
                                                <p className='text-muted mb-2'>
                                                    Velzon admin is super
                                                    flexible, powerful, clean,
                                                    modern & responsive admin
                                                    template based on{' '}
                                                    <span className='fw-semibold'>
                                                        bootstrap 5
                                                    </span>{' '}
                                                    stable with unlimited
                                                    possibilities. You can
                                                    simply change to any layout
                                                    or mode by changing a couple
                                                    of lines of code. You can
                                                    start small and large
                                                    projects or update design in
                                                    your existing project using
                                                    Velzon it is very quick and
                                                    easy as it is beautiful,
                                                    adroit, and delivers the
                                            ...
                                            <div className='py-3'>
                                                ...
                                                <p className='text-muted mb-2'>
                                                    Skote is an admin dashboard
                                                    template that is a
                                                    beautifully crafted, clean &
                                                    minimal designed admin
                                                    template with Dark, Light
                                                    Layouts with RTL options.
                                                    You can build any type of
                                                    web application like Saas
                                                    based interface, eCommerce,
                                                    Crypto, CRM, CMS, Project
                                                    management apps, Admin
                                                    Panels, etc.
                                                </p>
                                                <ul className='list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0'>
                                                    <li className='list-inline-item me-3'>
                                            ...
                                            <div className='py-3'>
                                                ...
                                                <p className='text-muted mb-2'>
                                                    Minia react is a simple and
                                                    beautiful admin template
                                                    built with Bootstrap ^5.1.3.
                                                    It has{' '}
                                                    <span className='fw-semibold'>
                                                        5+ different layouts and
                                                        3 modes
                                                    </span>{' '}
                                                    ( Dark, Light & RTL ) which
                                                    are managed by SCSS only.
                                                    You can simply change to any
                                                    layouts or mode by changing
                                                    a couple of lines code.
                                                </p>
                                                <ul className='list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0'>
                                                    <li className='list-inline-item me-3'>
                                                        <i className='ri-thumb-up-line align-middle me-1'></i>
                                            ...
                                            <div className='py-3'>
                                                ...
                                                <p className='text-muted mb-2'>
                                                    Dason is a simple and
                                                    beautiful admin template
                                                    built with Bootstrap ^5.1.3.
                                                    It has 5+ different layouts
                                                    and 3 modes ( Dark, Light &
                                                    RTL ) which are managed by
                                                    SCSS only. You can simply
                                                    change to any layouts or
                                                    mode by changing a couple of
                                                    lines code.
                                                </p>
                                                <ul className='list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0'>
                                                    <li className='list-inline-item me-3'>
