                                ...
                                <CardBody className='p-4'>
                                    <div>
                                        ...
                                        <p className='text-muted'>
                                            ...
                                            Website Name if you do not agree to
                                            take all of the terms and conditions
                                            stated on this page.
                                        </p>
                                        <p className='text-muted'>
                                            Most interactive websites use
                                            cookies to let us retrieve the
                                            user's details for each visit.
                                            Cookies are used by our website to
                                            enable the functionality of certain
                                            areas to make it easier for people
                                    ...
                                    <div>
                                        ...
                                        <p className='text-muted'>
                                            ...
                                            Name and/or its licensors own the
                                            intellectual property rights for all
                                            material on Website Name. All
                                            intellectual property rights are
                                            reserved. You may access this from
                                            Website Name for your own personal
                                            use subjected to restrictions set in
                                    ...
                                    <div>
                                        <p className='text-muted'>
                                            ...
                                            monitor all Comments and to remove
                                        ...
                                        <p className='text-muted'>
                                            You hereby grant Company Name a
                                            non-exclusive license to use,
                                            reproduce, edit and authorize others
                                            to use, reproduce and edit any of
                                            your Comments in any and all forms,
                                            formats or media.
                                        </p>
                                        <p className='text-muted'>
                                        ...
                                        <ul className='text-muted vstack gap-2'>
                                            ...
                                            <li>
                                                By use of any other description
                                                of our Website being linked to
                                                that makes sense within the
                                                context and format of content on
                                                the linking party's site.
                                            </li>
                                        </ul>
                                        <p className='text-muted fw-semibold'>
                                            No use of Company Name's logo or
