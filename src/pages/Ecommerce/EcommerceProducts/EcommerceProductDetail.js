                ...
                <div className='p-2 border border-dashed rounded'>
                    <div className='d-flex align-items-center'>
                        ...
                        <div className='flex-grow-1'>
                            ...
                            <h5 className='mb-0'>
                                {props.pricingDetails.labelDetail}
                            </h5>
                        </div>
                    </div>
                </div>
                                    ...
                                    <Col xl={8}>
                                        <div className='mt-xl-0 mt-5'>
                                            ...
                                            <div className='mt-4 text-muted'>
                                                ...
                                                <p>
                                                    Tommy Hilfiger men striped
                                                    pink sweatshirt. Crafted
                                                    with cotton. Material
                                                    composition is 100% organic
                                                    cotton. This is one of the
                                                    world’s leading designer
                                                    lifestyle brands and is
                                                    internationally recognized
                                                    for celebrating the essence
                                                    of classic American cool
                                                    style, featuring preppy with
                                                    a twist designs.
                                                </p>
                                            </div>
                                            ...
                                            <div className='product-content mt-5'>
                                                ...
                                                <Nav
                                                    tabs
                                                    className='nav-tabs-custom nav-primary'
                                                >
                                                    <NavItem>
                                                        <NavLink
                                                            style={{
