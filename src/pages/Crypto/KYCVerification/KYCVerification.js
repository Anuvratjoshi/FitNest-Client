                                ...
                                <Row className='justify-content-center'>
                                    <Col lg={9}>
                                        ...
                                        <p className='text-muted mt-3'>
                                            When you get your KYC verification
                                            process done, you have given the
                                            crypto exchange in this case,
                                            information.{' '}
                                        </p>
                                        <div className='mt-4'>
                                            <button
                                ...
                                <Row className='text-center justify-content-center'>
                                    <Col lg={12}>
                                        ...
                                        <p className='text-muted mb-4'>
                                            ...
                                            meta tag form your site's home page.
                                            To avoid losing verification, you
                                            may want to add multiple methods
                                            form the{' '}
